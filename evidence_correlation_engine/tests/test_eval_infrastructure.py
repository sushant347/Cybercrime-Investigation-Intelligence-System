...
from ciis_correlation import OCR_ENGINE_ROOT
from ciis_correlation.core.data_access import EntityRecord, EvidenceContext
from ciis_correlation.evaluation.correlation_baselines import (
    exact_match_pairs,
...
from ciis_correlation.evaluation.timeline_eval import (
    evaluate_timestamp_accuracy,
)

#: Gold-label corpora ship with the upstream OCR engine (they reference its
#: sample images). Resolved from the engine root the package already knows
#: about rather than by counting directories up from this file.
GT = OCR_ENGINE_ROOT / "samples" / "ground_truth"
