...
def config(tmp_path: Path) -> EvidenceConfig:
    ...
    This engine's tests used to inherit this fixture from the OCR engine's root
    conftest, back when they lived inside that package. They are a separate
    suite now, so the upstream configuration they analyse is built here.
    """
