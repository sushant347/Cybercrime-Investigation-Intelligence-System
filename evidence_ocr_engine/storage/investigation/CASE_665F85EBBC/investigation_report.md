# Forensic Investigation Report - CASE_665F85EBBC

Generated: 2026-08-08T05:54:02.368Z  
...
- Case CASE_665F85EBBC contains 9 evidence items, each acquired under SHA-256 chain-of-custody verification.
- This case is linked to 2 other cases through shared entities: CASE_1A1BF573F3, CASE_EE8250FB76 [cross_case_correlation.json].
- The weighted correlation engine found 36 related evidence pairs out of 36 analysed [correlation_analysis.json].
- 1 coordinated campaign were identified; the largest (CAMP_CASE_665F85EBBC_01) groups 5 items [campaign_analysis.json].
...
- **evidence scope**: 9 evidence items acquired through the CIIS intake pipeline under SHA-256 chain-of-custody control.
- **methodology**:
...
- **case id**: CASE_665F85EBBC
- **evidence count**: 9
- **first evidence**: 2026-08-08T01:55:56.896Z
- **last evidence**: 2026-08-08T02:08:00.449Z
- **file types**:
  - jpg
  - pdf
  - png
...
- **upload time**: 2026-08-08T01:59:04.172Z
...
- **upload time**: 2026-08-08T02:08:00.449Z
...
- **summary**: 9 events spanning 1331.2 hours; 0 timestamps unresolved. Observed scam progression: initial_contact -> financial_transaction -> social_engineering -> post_attack.
- **stage progression**:
  - initial_contact
...
- **milestones**:
  ...
  - **timestamp**: 2026-06-14T00:00:00+00:00
  - **description**: First observation of stage 'initial_contact' (EVID_00032)
  - **timestamp**: 2026-06-14T00:00:00+00:00
  - **description**: First observation of stage 'financial_transaction' (EVID_00032)
  - **timestamp**: 2026-08-08T01:57:18.794000+00:00
  - **description**: First observation of stage 'social_engineering' (EVID_00031)
  - **timestamp**: 2026-08-08T01:59:04.172000+00:00
  - **description**: First observation of stage 'post_attack' (EVID_00033)
- **critical events**:
  - **timestamp**: 2026-06-14T00:00:00+00:00
  - **evidence id**: EVID_00032
  - **reasons**:
...
- **strength distribution**:
  ...
  - **WEAK**: 26
- **top relationships**:
  - **pair**: EVID_00030 <-> EVID_00033
  - **strength**: VERY_STRONG
  - **confidence**: 0.9388
  - **explanation**: EVID_00030 (05_khalti_receipt.jpg) and EVID_00033 (08_complaint_letter.pdf) show a very strong relationship (confidence 0.94) based on 7 independent factors. Both items reference the same phones: +9779801122334, +9779847011223 [weight 1.26]. Both items reference the same khalti ids: +9779801122334 [weight 0.78]. Both items reference the same transaction ids: kh-2026-0611-77245 [weight 0.74]. Both items reference the same domains: esewa-cashback-offer.xyz [weight 0.42]. Both items reference the same money: npr 1500 [weight 0.07]. Acquired 0.0 hours apart (within the 48h proximity window) [weight 0.40]. Threat intelligence flags the same malicious indicator in both items: esewa-cashback-offer.xyz [weight 0.80].
  - **pair**: EVID_00027 <-> EVID_00033
  - **strength**: STRONG
  - **confidence**: 0.7709
  - **explanation**: EVID_00027 (02_messenger_chat.jpg) and EVID_00033 (08_complaint_letter.pdf) show a strong relationship (confidence 0.77) based on 5 independent factors. Both items reference the same emails: sunita.gurung21@gmail.com [weight 0.66]. Both items reference the same esewa ids: sunita.gurung21@gmail.com [weight 0.78]. Both items reference the same domains: gmail.com [weight 0.46]. Both items reference the same money: npr 200 [weight 0.06]. Acquired 0.0 hours apart (within the 48h proximity window) [weight 0.40].
  - **pair**: EVID_00032 <-> EVID_00033
  - **strength**: STRONG
  - **confidence**: 0.6814
  - **explanation**: EVID_00032 (07_bank_transfer_slip.pdf) and EVID_00033 (08_complaint_letter.pdf) show a strong relationship (confidence 0.68) based on 4 independent factors. Both items reference the same phones: +9779847011223 [weight 0.63]. Both items reference the same transaction ids: mbl-2026-441829 [weight 0.74]. Both items reference the same money: npr 25000 [weight 0.06]. Acquired 0.0 hours apart (within the 48h proximity window) [weight 0.40].
  - **pair**: EVID_00028 <-> EVID_00033
  - **strength**: STRONG
  - **confidence**: 0.6491
  - **explanation**: EVID_00028 (03_qr_code_flyer.png) and EVID_00033 (08_complaint_letter.pdf) show a strong relationship (confidence 0.65) based on 4 independent factors. Both items reference the same domains: esewa-cashback-offer.xyz [weight 0.42]. Both items reference the same money: npr 5000 [weight 0.06]. Acquired 0.0 hours apart (within the 48h proximity window) [weight 0.40]. Threat intelligence flags the same malicious indicator in both items: esewa-cashback-offer.xyz [weight 0.80].
  - **pair**: EVID_00028 <-> EVID_00030
  - **strength**: STRONG
  - **confidence**: 0.6365
  - **explanation**: EVID_00028 (03_qr_code_flyer.png) and EVID_00030 (05_khalti_receipt.jpg) show a strong relationship (confidence 0.64) based on 3 independent factors. Both items reference the same domains: esewa-cashback-offer.xyz [weight 0.42]. Acquired 0.0 hours apart (within the 48h proximity window) [weight 0.40]. Threat intelligence flags the same malicious indicator in both items: esewa-cashback-offer.xyz [weight 0.80].
...
- **unclustered evidence**:
  ...
  - EVID_00034
- **campaigns**:
  - **campaign id**: CAMP_CASE_665F85EBBC_01
  - **members**:
    - EVID_00027
    - EVID_00028
    - EVID_00030
  ...
  - **summary**: Campaign CAMP_CASE_665F85EBBC_01 groups 5 evidence items with mean link confidence 0.74. Shared indicators: domains:esewa-cashback-offer.xyz, phones:+9779847011223, dates:11 june 2026, domains:gmail.com, emails:sunita.gurung21@gmail.com. Active 2026-08-08T01:56:19.932Z to 2026-08-08T01:59:04.172Z.

## Suspect Assessment

- **suspect id**: SUSPECT_CASE_665F85EBBC_09
...
- **evidence ids**:
  - EVID_00030
  - EVID_00033
- **explanation**: Suspect anchor '+9779801122334' (khalti_ids) scores 77.8/100 (HIGH, risk HIGH) across 2 evidence items: EVID_00030, EVID_00033. Identity strength: 100/100 (weight 0.25) - '+9779801122334' is a khalti_id - identity weight 100/100 for this anchor type. Evidence count: 50/100 (weight 0.20) - appears in 2 of 9 evidence items. Evidence confidence: 92/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 92/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'esewa-cashback-offer.xyz' in EVID_00030. Correlation strength: 94/100 (weight 0.15) - its 2 evidence items are inter-linked with mean correlation confidence 0.94 (strongest: VERY_STRONG). Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: phones:+9779801122334, phones:+9779847011223.
- **suspect id**: SUSPECT_CASE_665F85EBBC_12
- **identity**: phones:+9779847011223
- **confidence score**: 75.9
- **confidence level**: HIGH
- **risk level**: HIGH
- **evidence ids**:
  - EVID_00030
  - EVID_00032
  - EVID_00033
- **explanation**: Suspect anchor '+9779847011223' (phones) scores 75.9/100 (HIGH, risk HIGH) across 3 evidence items: EVID_00030, EVID_00032, EVID_00033. Identity strength: 85/100 (weight 0.25) - '+9779847011223' is a phone - identity weight 85/100 for this anchor type. Evidence count: 75/100 (weight 0.20) - appears in 3 of 9 evidence items. Evidence confidence: 94/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 94/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'esewa-cashback-offer.xyz' in EVID_00030. Correlation strength: 70/100 (weight 0.15) - its 3 evidence items are inter-linked with mean correlation confidence 0.70 (strongest: VERY_STRONG). Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: khalti_ids:+9779801122334, phones:+9779801122334.
- **suspect id**: SUSPECT_CASE_665F85EBBC_08
- **identity**: esewa_ids:sunita.gurung21@gmail.com
- **confidence score**: 75.4
- **confidence level**: HIGH
- **risk level**: HIGH
- **evidence ids**:
  - EVID_00027
  - EVID_00033
- **explanation**: Suspect anchor 'sunita.gurung21@gmail.com' (esewa_ids) scores 75.4/100 (HIGH, risk HIGH) across 2 evidence items: EVID_00027, EVID_00033. Identity strength: 100/100 (weight 0.25) - 'sunita.gurung21@gmail.com' is a esewa_id - identity weight 100/100 for this anchor type. Evidence count: 50/100 (weight 0.20) - appears in 2 of 9 evidence items. Evidence confidence: 92/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 92/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'https://esewa-cashback-offer.xyz/claim' in EVID_00033. Correlation strength: 77/100 (weight 0.15) - its 2 evidence items are inter-linked with mean correlation confidence 0.77 (strongest: STRONG). Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: emails:sunita.gurung21@gmail.com.
- **suspect id**: SUSPECT_CASE_665F85EBBC_11
...
- **evidence ids**:
  ...
  - EVID_00031
  - EVID_00033
- **explanation**: Suspect anchor '+9779801122334' (phones) scores 73.9/100 (HIGH, risk HIGH) across 3 evidence items: EVID_00030, EVID_00031, EVID_00033. Identity strength: 85/100 (weight 0.25) - '+9779801122334' is a phone - identity weight 85/100 for this anchor type. Evidence count: 75/100 (weight 0.20) - appears in 3 of 9 evidence items. Evidence confidence: 88/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 88/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'esewa-cashback-offer.xyz' in EVID_00030. Correlation strength: 63/100 (weight 0.15) - its 3 evidence items are inter-linked with mean correlation confidence 0.63 (strongest: VERY_STRONG). Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: khalti_ids:+9779801122334, phones:+9779847011223.
- **suspect id**: SUSPECT_CASE_665F85EBBC_05
...
- **evidence ids**:
  - EVID_00027
  - EVID_00033
- **explanation**: Suspect anchor 'sunita.gurung21@gmail.com' (emails) scores 69.2/100 (HIGH, risk HIGH) across 2 evidence items: EVID_00027, EVID_00033. Identity strength: 75/100 (weight 0.25) - 'sunita.gurung21@gmail.com' is a email - identity weight 75/100 for this anchor type. Evidence count: 50/100 (weight 0.20) - appears in 2 of 9 evidence items. Evidence confidence: 92/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 92/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'https://esewa-cashback-offer.xyz/claim' in EVID_00033. Correlation strength: 77/100 (weight 0.15) - its 2 evidence items are inter-linked with mean correlation confidence 0.77 (strongest: STRONG). Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: esewa_ids:sunita.gurung21@gmail.com.
- **suspect id**: SUSPECT_CASE_665F85EBBC_02
...
- **evidence ids**:
  - EVID_00030
- **explanation**: Suspect anchor '+9779847011223' (khalti_ids) scores 65.0/100 (HIGH, risk HIGH) across 1 evidence item: EVID_00030. Identity strength: 100/100 (weight 0.25) - '+9779847011223' is a khalti_id - identity weight 100/100 for this anchor type. Evidence count: 25/100 (weight 0.20) - appears in 1 of 9 evidence items. Evidence confidence: 83/100 (weight 0.15) - mean Phase-1 evidence confidence of its evidence set is 83/100. Threat intelligence: 100/100 (weight 0.15) - co-occurs with threat-flagged indicator 'esewa-cashback-offer.xyz' in EVID_00030. Correlation strength: 50/100 (weight 0.15) - fewer than two evidence items (or no correlation input); neutral 50. Timeline span: 0/100 (weight 0.10) - activity spans 0.0 days across its evidence set. Co-occurring identity entities: khalti_ids:+9779801122334, phones:+9779801122334, phones:+9779847011223.
- **suspect id**: SUSPECT_CASE_665F85EBBC_04
...
- **predictions**:
  ...
  - **ssl status**: VALID
  - **domain age days**: 11318
  - **registrar**: MarkMonitor, Inc.
  - **spf present**: True
  - **dmarc present**: True
  - **ssl days left**: 65
  - **hosting**: Google LLC, United States
  - **ip address**: 142.250.195.37
  - **reasons**:
...
- **mean evidence confidence**: 89.86
- **mean forgery score**: 17.18
- **max forgery score**: 25.2
- **mean ocr confidence**: 0.92
...
- **timeline statistics**:
  ...
  - **inferred event count**: 9.0
  - **stage count**: 4.0
  - **critical event count**: 7.0
  - **timeline span hours**: 1331.25
- **correlation statistics**:
  - **pair count**: 36.0
  - **related pair count**: 36.0
  - **mean confidence**: 0.3308
  - **max confidence**: 0.9388
...
- **score**: 83.6
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 83.6/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: image_quality (62/100).
- **evidence id**: EVID_00027
- **score**: 84.7
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 84.7/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: image_quality (66/100).
- **evidence id**: EVID_00028
- **score**: 92.9
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 92.9/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: metadata (80/100).
- **evidence id**: EVID_00029
- **score**: 82.8
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 82.8/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: image_quality (56/100).
- **evidence id**: EVID_00030
- **score**: 83.2
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 83.2/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: image_quality (68/100).
- **evidence id**: EVID_00031
- **score**: 81.5
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 81.5/100 (VERY_HIGH), derived from 5 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: image_quality (55/100).
- **evidence id**: EVID_00032
- **score**: 100.0
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 100.0/100 (VERY_HIGH), derived from 3 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: metadata (100/100).
- **evidence id**: EVID_00033
- **score**: 100.0
- **level**: VERY_HIGH
- **explanation**: Evidence confidence is 100.0/100 (VERY_HIGH), derived from 3 verified dimensions. Strongest signal: hash_verification (100/100). Weakest signal: metadata (100/100).
...
- 9/9 evidence items passed SHA-256 chain-of-custody verification.
- The evidence set is internally connected (36 weighted relationships), consistent with related activity rather than isolated incidents.
...
**Evidence.** EVID_00027, EVID_00028, EVID_00029, EVID_00030, EVID_00032, EVID_00033
...
**Why this is engaged.** threat intelligence flagged 6 indicators in this case; the evidence carries 10 web addresses (eSewa-cashback-offer.xyz and esewa-cashback-offer.xyz), i.e. material published in electronic form.

**Evidence.** EVID_00027, EVID_00028, EVID_00029, EVID_00030, EVID_00033, EVID_00034
...
**Why this is engaged.** campaign CAMP_CASE_665F85EBBC_01 groups 5 evidence items by shared indicators, which evidences coordinated activity rather than a single isolated act.

**Evidence.** EVID_00027, EVID_00028, EVID_00030, EVID_00032, EVID_00033
...
**Why this is engaged.** campaign CAMP_CASE_665F85EBBC_01 evidences coordination across 5 evidence items. Where more than one person acted, anyone who assisted is liable to one half of the principal's punishment.
...
**Why this is engaged.** brand marks were detected in the evidence (Facebook, Google, Khalti and 5 more) across 4 evidence items. Where the material was not published by the mark's owner, its use is unauthorised. Registration and authority are matters of record to be confirmed.

**Evidence.** EVID_00027, EVID_00028, EVID_00029, EVID_00030
...
- Get the fake websites shut down: esewa-cashback-offer.xyz, esewa-verify-kyc.com (+3 more). Ask the hosting company to save its records first.
...
- Give this case early attention (rated 75 out of 100).

## Report Provenance & Integrity

- **report id**: RPT-665F85EBBC-BD9138D0
- **generated at**: 2026-08-08T05:54:02.348Z
- **generator**: CIIS Phase-2 reporting module (template-over-data; no free-text generation)
- **evidence set digest**: b4abb4acebd510b7f32e0c36a9af48caddb7fb92b091e1451db4d3c365408eba
...
- **source artifact hashes**:
  - **correlation analysis.json**: 447328097b416f3552da2ec5902d39d094450b25aba7e386cc5456f2bb96e044
  - **cross case correlation.json**: cc4821af400a2647f5de993d278f07202de90a45468dbcdc58bf95942dd2edd9
  - **campaign analysis.json**: 1be534f9a1561fbd1a5f10d276716570ebc4609e678a0a8af519c3ac66fb5d56
  - **suspect assessment.json**: 3132c54c9b106e02464976269c7b1ce3dca02ef299d237973d7a5d25e2acba3a
  - **timeline analysis.json**: c5a423aba99d5d73a4460ed1c86653f035eb2a102159c799a1e23907a9773fc4
  - **analytics.json**: 0eba20d4e2fb0e2b9946d3cc1d588242723e06012c95e2d2c2947ec0a9c9a1a4
  - **case priority.json**: 34f4d075294dee291f744e5ade6ec9d172024e34a6eb95bd82e427cfa6c30df3
  - **graph.json**: 66983b4e1bac491d65980084858cfc7e8b1319f09e05d30783d657d8b46f1dbd
