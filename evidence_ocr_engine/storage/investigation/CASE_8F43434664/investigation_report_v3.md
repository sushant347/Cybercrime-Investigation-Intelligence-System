...
Generated: 2026-07-24T16:20:56.692Z  
...
- This case is linked to 3 other case(s) through shared entities: CASE_2CF24DBA5F, CASE_F1278DD84F, CASE_85B2471DFB [cross_case_correlation.json].
...
- **links**:
  ...
  - **relationship strength**: WEAK
  - **match confidence**: 0.1175
  - **match reason**: Shares 1 entity(ies) with CASE_85B2471DFB: money rs 2000
  - **matched entities**:
    - **entity type**: money
    - **value**: rs 2000
    - **this evidence ids**:
