...
by one or more retrieved evidence IDs.

Return one JSON object with exactly these fields:
{"answer": "concise answer with inline [EVID_ID] citations",
 "citations": ["EVID_ID"],
 "insufficient_evidence": false}
The citations array may contain only evidence IDs visible in the context."""
