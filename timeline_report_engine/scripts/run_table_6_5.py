...
Runs ``ciis_timeline_report/timeline/service.py``, the production adapter over
``ciis_timeline_report.timeline.engine``, and reports order accuracy, timestamp
accuracy and unresolved rate against human gold, plus the naive
upload-time-order baseline. Numbers only when real gold exists.
...
from ciis_timeline_report.timeline.service import TimelineService  # noqa: E402
